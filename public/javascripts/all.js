...
$(".gy_treasure_kind_bgpic3").hover(function(event){
    $(this).css("color", "#29A7E1");
     $(this).css("background", "url(/public/images/home/gy_treasure_kind030.png) no-repeat center center");
     $("#gy_treasure_kind_bigfont3").css("color", "#29A7E1");
	}, function(event){
    $(this).css("background", "url(/public/images/home/gy_treasure_kind03.png) no-repeat center center");
    ...
    $(this).css("color", "#29A7E1");
     $(this).css("background", "url(/public/images/home/gy_treasure_kind010.png) no-repeat center center");
     $("#gy_treasure_kind_bigfont1").css("color", "#29A7E1");
	}, function(event){
    $(this).css("background", "url(/public/images/home/gy_treasure_kind01.png) no-repeat center center");
    $("#gy_treasure_kind_bigfont1").css("color", "#555555");
	} );

$(".gy_treasure_kind_bgpic2").hover(function(event){
    $(this).css("color", "#29A7E1");
     $(this).css("background", "url(/public/images/home/gy_treasure_kind020.png) no-repeat center center");
     $("#gy_treasure_kind_bigfont2").css("color", "#29A7E1");
	}, function(event){
    $(this).css("background", "url(/public/images/home/gy_treasure_kind02.png) no-repeat center center");
    $("#gy_treasure_kind_bigfont2").css("color", "#555555");
	} );
	
$(".gy_treasure_kind_bgpic4").hover(function(event){
    $(this).css("color", "#29A7E1");
     $(this).css("background", "url(/public/images/home/gy_treasure_kind040.png) no-repeat center center");
     $("#gy_treasure_kind_bigfont4").css("color", "#29A7E1");
	}, function(event){
    $(this).css("background", "url(/public/images/home/gy_treasure_kind04.png) no-repeat center center");
    $("#gy_treasure_kind_bigfont4").css("color", "#555555");
	} );	
$(".gy_treasure_kind_bgpic5").hover(function(event){
    $(this).css("color", "#29A7E1");
     $(this).css("background", "url(/public/images/home/gy_treasure_kind050.png) no-repeat center center");
     $("#gy_treasure_kind_bigfont5").css("color", "#29A7E1");
	}, function(event){
    $(this).css("background", "url(/public/images/home/gy_treasure_kind05.png) no-repeat center center");
